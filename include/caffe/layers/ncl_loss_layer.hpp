...
class NCLLossLayer : public LossLayer<Dtype> {
 public:
  explicit NCLLossLayer(const LayerParameter& param)
  ...
  virtual inline const char* type() const { return "NCLLoss"; }
  /**
   * Unlike most loss layers, in the NCLLossLayer we can backpropagate
