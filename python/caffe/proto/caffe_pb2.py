...
_POOLINGPARAMETER_POOLMETHOD = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='RANKSTOCHASTIC', index=3, number=3,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='EXPSTOCHASTIC', index=4, number=4,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='VALUEWEIGHTING', index=5, number=5,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='RANKWEIGHTING', index=6, number=6,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='RANKAVE', index=7, number=7,
      options=None,
      type=None),
  ],
  containing_type=None,
...
_LAYERPARAMETER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='ncl_loss_param', full_name='caffe.LayerParameter.ncl_loss_param', index=40,
...
_POOLINGPARAMETER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='p_a', full_name='caffe.PoolingParameter.p_a', index=12,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='select_num', full_name='caffe.PoolingParameter.select_num', index=13,
      number=14, type=13, cpp_type=3, label=1,
      has_default_value=True, default_value=5,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_NCLLOSSPARAMETER = _descriptor.Descriptor(
  name='NCLLossParameter',
  full_name='caffe.NCLLossParameter',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='lambda', full_name='caffe.NCLLossParameter.lambda', index=0,
      number=1, type=2, cpp_type=6, label=1,
      has_default_value=True, default_value=1,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='net_num', full_name='caffe.NCLLossParameter.net_num', index=1,
      number=2, type=13, cpp_type=3, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_LAYERPARAMETER.fields_by_name['ncl_loss_param'].message_type = _NCLLOSSPARAMETER
...
DESCRIPTOR.message_types_by_name['NCLLossParameter'] = _NCLLOSSPARAMETER
...
NCLLossParameter = _reflection.GeneratedProtocolMessageType('NCLLossParameter', (_message.Message,), dict(
  DESCRIPTOR = _NCLLOSSPARAMETER,
  __module__ = 'caffe_pb2'
  # @@protoc_insertion_point(class_scope:caffe.NCLLossParameter)
  ))
_sym_db.RegisterMessage(NCLLossParameter)
